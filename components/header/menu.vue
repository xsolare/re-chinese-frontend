<template>
  <div ref="menuRef" v-click-outside="{ callback: (value) => systemStore.toggleMenu(value) }" class="menu">
    <ul>
      <li v-if="userStore.isLoggedIn" class="profile" @click="handleClickClose">
        <NuxtLink :to="'/'">
      ...
      <li v-else class="profile" @click="handleClickClose">
      ...
      <li class="menu-item" @click="handleClickClose">
        <NuxtLink :to="'/'">
          <img src="/assets/image/duoluo_dalu.jpeg" alt="" class="menu-item__icon" />
          <span>None</span>
        </NuxtLink>
      </li>
      <li class="menu-item" @click="handleClickClose">
